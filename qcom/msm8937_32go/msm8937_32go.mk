...
PRODUCT_COPY_FILES += device/qcom/msm8937_32go/media/media_profiles_8937.xml:system/etc/media_profiles.xml \
                      ...
                      device/qcom/msm8937_32go/media/media_codecs_vendor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_8937_v1.xml \
                      device/qcom/msm8937_32go/media/media_codecs_vendor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_vendor.xml \
...
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE += \
    device/qcom/msm8937_32go/vendor_framework_compatibility_matrix.xml
...
ifeq ($(ENABLE_KM_4_0), true)
    DEVICE_MANIFEST_FILE += device/qcom/msm8937_32go/keymaster.xml
else
    DEVICE_MANIFEST_FILE += device/qcom/msm8937_32go/keymaster_ota.xml
endif
